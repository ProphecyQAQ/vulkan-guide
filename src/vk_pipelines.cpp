...
VkPipeline PipelineBuilder::build_pipeline(VkDevice device)
{
    ...
    if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &pipeline) != VK_SUCCESS) {
        fmt::println("[PipelineBuilder] [build_pipeline] failed to create pipeline");
...
{
    _multisampling.sampleShadingEnable = VK_FALSE; // no multisampling
...
void PipelineBuilder::enable_blend_additive()
{
    _colorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
...
void PipelineBuilder::enable_blend_alphablend()
{
    _colorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
    _colorBlendAttachment.blendEnable = VK_TRUE;
    _colorBlendAttachment.srcColorBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;
...
void PipelineBuilder::set_color_attachment_format(VkFormat format)
{
    ...
    // conect the format to the renderinfo struct
